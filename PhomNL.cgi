...
<tr>
<td><div class="kalelink">The daily precipitation deficit, cumulative Makkink evaporation minus precipitation (set to zero when negative):
<ul>
<li><a href="getindices.cgi?WMO=KNMIData/nt_nl&STATION=precipitationdeficit&TYPE=i&id=$EMAIL&NPERYEAR=366">official series for the Netherlands</a>,
<li>unofficial series averaged over
...
<a href="getindices.cgi?WMO=KNMIData/nt_mean_inland&STATION=precipitation_deficit_inland&TYPE=i&id=$EMAIL&NPERYEAR=366">inland</a> regions,
<li>instantaneous values of PET-P in 
...
<a href="getindices.cgi?WMO=KNMIData/nt_inst_inland&STATION=PET-P_inland&TYPE=i&id=$EMAIL&NPERYEAR=366">inland</a> regions.
</ul>
...
The official series is based on thirteen 8-8 rain gauge series and potential evaopartion derived from De Bilt temperature and sunshine 1906-2000. From 2001 onward it is computed from the same 13 manual rain gauge stations and temperature and sunshine at automatic stations closest to these precipitation stations. This series is plotted <a href="https://www.knmi.nl/nederland-nu/klimatologie/geografische-overzichten/neerslagtekort_droogte">here</a>. The unofficial series use all automatic stations for precipitation, temperature and sunshine (so a <a href="getdutchstations.cgi?id=$EMAIL&TYPE=ev">varying number of stations</a>). The automatic rain gauges record on average about 5% less rain than the manual rain gauges.</a>
</table>
EOF
