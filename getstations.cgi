...
EOF
    ...
    if [ "$FORM_climate" = "precipitation" ]; then
        ...
        prog=ecaclou
        type=c
    elif [ "$FORM_climate" = "ecaglob" ]; then
        prog=ecaglob
        type=q
    elif [ "$FORM_climate" = "ecawspd" ]; then
        prog=ecawspd
        type=w
    elif [ "$FORM_climate" = "ecagust" ]; then
        prog=ecagust
        type=g
    elif [ "$FORM_climate" = "ecawdir" ]; then
        prog=ecawdir
        type=v
        ...
        prog=becaclou
        type=c
    elif [ "$FORM_climate" = "becaglob" ]; then
        prog=becaglob
        type=q
    elif [ "$FORM_climate" = "becawspd" ]; then
        prog=becawspd
        type=w
    elif [ "$FORM_climate" = "becagust" ]; then
        prog=becagust
        type=g
    elif [ "$FORM_climate" = "becawdir" ]; then
        prog=becawdir
        type=v
