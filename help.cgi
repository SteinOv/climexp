...
<p>In the Climate Explorer pages, the <a href="help.cgi?id=$EMAIL"><img src="images/info-i.gif" alt="help" border="0"></a> symbol indicates a help pop-up.  Below an alphabetical list of these pop-ups is given.  Please contact <a href="mailto:climate-explorer@knmi.nl">the administrator</a> if the help text is confusing, or missing in a place where it is needed.
