...
<br>Note: I 14-feb-2019 Replaced the flawed "scaling" option with a better model uncertainty additive term.</font><p>
...
plot ${line} notitle w line lt 0, \
    '${root}.txt' using (\$0):(STATS_min/1.1):9 notitle with labels rotate right, \
    '${root}.txt' using (\$0):3:(\$0-0.2):(\$0+0.2):6:7:8 notitle with boxxyerrorbars fs solid 0 border -1 lw 2, \
    '${root}.txt' using (\$0):3:(\$0-0.2):(\$0+0.2):4:5:8 notitle with boxxyerrorbars fs solid 0.5 lc variable, \
