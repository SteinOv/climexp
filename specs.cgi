...
<p><font color=#FF1010"><blink>For an interactive version of these plots and to better understand the sources of predictability go to <a href="http://climexp.knmi.nl/kprep_fc/">KPREP sources of predictability</a>.
...
firstdate=`ls KPREPData/plots/$dataset/25/ | tr " " "\n" | tail -1`
firstyear=${firstdate%??}
...
<img id="imageToSwap" src="KPREPData/plots/$dataset/25/$date/${dataset}_${prefix}$date.png" width="100%" />
