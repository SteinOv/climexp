...
ecaglob) climate_ecaglob="checked";;
ecawspd) climate_ecawspd="checked";;
ecagust) climate_ecagust="checked";;
ecawdir) climate_ecawdir="checked";;
...
becaglob) climate_becaglob="checked";;
becawspd) climate_becawspd="checked";;
becagust) climate_becagust="checked";;
becawdir) climate_becawdir="checked";;
