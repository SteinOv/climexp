...
<a href="http://www.gloss-sealevel.org/"><img align="right" src="images/info-i.gif" alt="help" border="0"></a><input type="radio" class="formradio" name="climate" value="sealev" $climate_sealev>GLOSS sealevel
</td></tr><tr><td>
