...
country_values = [['Afghanistan', 'Afghanistan'],
               ...
               ['Iceland', 'Iceland'],
               ['India', 'India'],
               ['India_andman_nicobar', '&nbsp; Andman and Nicobar islands'],
               ['India_arunachal_pradesh', '&nbsp; Arunachal Pradesh'],
               ['India_assam_meghalaya', '&nbsp; Assam Meghalaya'],
               ['India_Bihar', '&nbsp; Bihar'],
               ['India_Chhattisgarh', '&nbsp; Chhattisgarh'],
               ['India_Coastal_Andhra_Pradesh', '&nbsp; Coastal Andhra Pradesh'],
               ['India_Coastal_Karnataka', '&nbsp; Coastal Karnataka'],
               ['India_East_MP', '&nbsp; East MP'],
               ['India_East_RJ', '&nbsp; East RJ'],
               ['India_East_UP', '&nbsp; East UP'],
               ['India_Gangetic_WB', '&nbsp; Gangetic WB'],
               ['India_Guj_Reg', '&nbsp; Guj Reg'],
               ['India_Himachal_Pradesh', '&nbsp; Himachal Pradesh'],
               ['India_Hry_Chd_Delhi', '&nbsp; Hry Chd Delhi'],
               ['India_Jammu_Kashmir', '&nbsp; Jammu Kashmir'],
               ['India_Jharkhand', '&nbsp; Jharkhand'],
               ['India_Kerala', '&nbsp; Kerala'],
               ['India_Konkan_Goa', '&nbsp; Konkan Goa'],
               ['India_Lakshadweep', '&nbsp; Lakshadweep'],
               ['India_Madhya_Maharashtra', '&nbsp; Madhya Maharashtra'],
               ['India_Marathwada', '&nbsp; Marathwada'],
               ['India_NMMT', '&nbsp; NMMT'],
               ['India_N_I_Karnataka', '&nbsp; N I Karnataka'],
               ['India_Odisha', '&nbsp; Odisha'],
               ['India_Punjab', '&nbsp; Punjab'],
               ['India_Rayalseema', '&nbsp; Rayalseema'],
               ['India_S_I_Karnataka', '&nbsp; S I Karnataka'],
               ['India_Saurashtra_Kutch', '&nbsp; Saurashtra Kutch'],
               ['India_Sub_Himalayan_WB', '&nbsp; Sub Himalayan WB'],
               ['India_TN_Puducherry', '&nbsp; TN Puducherry'],
               ['India_Telangana', '&nbsp; Telangana'],
               ['India_Uttarakhand', '&nbsp; Uttarakhand'],
               ['India_Vidarbha', '&nbsp; Vidarbha'],
               ['India_West_MP', '&nbsp; West MP'],
               ['India_West_RJ', '&nbsp; West RJ'],
               ['India_West_UP', '&nbsp; West UP'],
               ['Indonesia', 'Indonesia'],
               ['Iran', 'Iran'],
               ['Iraq', 'Iraq'],
               ['Ireland', 'Ireland'],
               ...
               ['Somalia', 'Somalia'],
               ['Somalia_south_central', '&nbsp; South-Central'],
...
dataset_values = [['CMIP5one', 'GCM: CMIP5 (IPCC AR5 Atlas subset)'],
                  ...
                  ['CORDEX-EUR44', 'RCM: CORDEX Europe 50km (uncorrected)'],
                  ['CMIP3', 'GCM: CMIP3'],
...
cmip5_extreme_values = [['altcdd','CDD: maximum length of dry spell'],
              ...
              ['tr','TR: number of tropical nights'],
...
obs_tasmax_values = [['cru4_tmx', 'CRU TS 4']]

obs_pr_values = [['gpcc_25_n1', 'GPCC'],
                 ['prca', 'NCDC anomalies'],
                 ['cru4_pre', 'CRU TS 4']]
