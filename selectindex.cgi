...
<tr><td>&nbsp;<td><div class="kalelink"><a href="getindices.cgi?WMO=NCEPData/cpc_nao&STATION=CPC_NAO&TYPE=i&id=$EMAIL">NAO</a> (rotated EOF of Z500, 1950-now, CPC)</div>
...
<td><a href="https://psl.noaa.gov/data/climateindices/list/#QBO" target="_new"><img src="images/info-i.gif" alt="more information" border="0"></a>
...
<tr><td>Global temperature<td><div class="kalelink">HadCRUT5 <a href="getindices.cgi?WMO=UKMOData/hadcrut5_global&STATION=HadCRUT5_global_temperature&TYPE=i&id=$EMAIL">Global average temperature</a>, <a href="getindices.cgi?WMO=UKMOData/hadcrut5_northern_hemisphere&STATION=HadCRUT5_NH&TYPE=i&id=$EMAIL">northern hemisphere</a>, <a href="getindices.cgi?WMO=UKMOData/hadcrut5_southern_hemisphere&STATION=HadCRUT5_SH&TYPE=i&id=$EMAIL">southern hemisphere</a> (1850-2018 Hadley Centre)</div>
<td><a href="http://www.metoffice.gov.uk/hadobs/hadcrut5/" target="_new"><img src="images/info-i.gif" alt="more information" border="0"></a>

<tr><td><td><div class="kalelink">CRUTEM5 <a href="getindices.cgi?WMO=UKMOData/crutem5_global&STATION=CRUTEM5_land_temperature&TYPE=i&id=$EMAIL">global land temperature</a>, <a href="getindices.cgi?WMO=UKMOData/crutem5_northern_hemisphere&STATION=CRUTEM5_NH_land_temperature&TYPE=i&id=$EMAIL">Northern Hemisphere</a>, <a href="getindices.cgi?WMO=UKMOData/crutem5_southern_hemisphere&STATION=CRUTEM5_SH_land_temperature&TYPE=i&id=$EMAIL">Southern Hemisphere</a> (1850-now CRU / Hadley Centre)</div>
<td><a href="https://www.metoffice.gov.uk/hadobs/crutem5/data/download.html" target="_new"><img src="images/info-i.gif" alt="more information" border="0"></a>

<tr><td><td><div class="kalelink">HadSST4 <a href="getindices.cgi?WMO=UKMOData/HadSST4_monthly_GLOBE&STATION=HadSST4_global&TYPE=i&id=$EMAIL">global</a>, <a href="getindices.cgi?WMO=UKMOData/HadSST4_monthly_NHEM&STATION=HadSST4_NH&TYPE=i&id=$EMAIL">Northern Hemisphere</a>, <a href="getindices.cgi?WMO=UKMOData/HadSST4_monthly_SHEM&STATION=STATION=HadSST4_SH&TYPE=i&id=$EMAIL">Southern Hemisphere</a>, <a href="getindices.cgi?WMO=UKMOData/HadSST4_monthly_TROP&STATION=STATION=HadSST4_tropics&TYPE=i&id=$EMAIL">Tropics</a> (1850-now CRU / Hadley Centre)</div>
<td><a href="https://www.metoffice.gov.uk/hadobs/hadsst4/data/download.html" target="_new"><img src="images/info-i.gif" alt="more information" border="0"></a>

<tr><td>&nbsp;<td><div class="kalelink">HadCRUT5 <a href="getindices.cgi?WMO=UKMOData/HadCRUT.5.0.1.0.analysis.ensemble_series.global.monthly.tas_@@&STATION=HadCRUT5_global_temperature&TYPE=i&id=$EMAIL">Global average temperature ensemble</a>, <a href="getindices.cgi?WMO=UKMOData/HadCRUT.5.0.1.0.analysis.ensemble_series.northern_hemisphere.monthly.tas_@@&STATION=HadCRUT5_NH&TYPE=i&id=$EMAIL">northern hemisphere ensemble</a>, <a href="getindices.cgi?WMO=UKMOData/HadCRUT.5.0.1.0.analysis.ensemble_series.southern_hemisphere.monthly.tas_@@&STATION=HadCRUT5_SH&TYPE=i&id=$EMAIL">southern hemisphere ensemble</a> (1850-2018 Hadley Centre)</div>
<td><a href="http://www.metoffice.gov.uk/hadobs/hadcrut5/" target="_new"><img src="images/info-i.gif" alt="more information" border="0"></a>

<tr><td>&nbsp;<td><div class="kalelink">NASA/GISS Ts+dSST <a href="getindices.cgi?WMO=NASAData/giss_al_gl_m&STATION=GISS_global_temperature&TYPE=i&id=$EMAIL">Land-Ocean average temperature</a> (<a href="getindices.cgi?WMO=NASAData/giss_sea&STATION=GISS_ocean_temperature&TYPE=i&id=$EMAIL">ocean only</a>), <a href="getindices.cgi?WMO=NASAData/giss_al_nh_m&STATION=GISS_NH_temperature&TYPE=i&id=$EMAIL">northern hemisphere</a>, <a href="getindices.cgi?WMO=NASAData/giss_al_sh_m&STATION=GISS_SH_temperature&TYPE=i&id=$EMAIL">southern hemisphere</a> (1880-now)</div><td><a href="http://data.giss.nasa.gov/gistemp/" target="_new"><img src="images/info-i.gif" alt="more information" border="0"></a>

<tr><td>&nbsp;<td><div class="kalelink">NOAA/NCEI <a href="getindices.cgi?WMO=NCDCData/ncdc_gl&STATION=NCDC_global_temperature&TYPE=i&id=$EMAIL">Global average temperature</a> (<a href="getindices.cgi?WMO=NCDCData/ncdc_gl_land&STATION=NCDC_global_land_temperature&TYPE=i&id=$EMAIL">land</a>, <a href="getindices.cgi?WMO=NCDCData/ncdc_gl_ocean&STATION=NCDC_global_ocean_temperature&TYPE=i&id=$EMAIL">ocean</a>), (1880-now)</div><td><a href="https://www.ncdc.noaa.gov/cag/global/time-series" target="_new"><img src="images/info-i.gif" alt="more information" border="0"></a>

<tr><td>&nbsp;<td><div class="kalelink">ERA5 <a href="getindices.cgi?WMO=ERA5/era5_t2m_gl&STATION=ERA_global_t2m&TYPE=i&id=$EMAIL">global T2m</a>, <a href="getindices.cgi?WMO=ERA5/era5_t2m_eu&STATION=ERA_europe_t2m&TYPE=i&id=$EMAIL">Europe land T2m</a> (1979-now) </div>
<td><a href="https://climate.copernicus.eu/climate-bulletin-about-data-and-analysis" alt="more information" border="0"></a>

<tr><td>&nbsp;<td><div class="kalelink"><a href="getindices.cgi?WMO=YorkData/had4_krig_v2_0_0_gl&STATION=CowtanWay_global_temperature&TYPE=i&id=$EMAIL">HadCRUT4, <a href="getindices.cgi?WMO=YorkData/had4sst4_krig_v2_0_0_gl&STATION=CowtanWay_global_temperature&TYPE=i&id=$EMAIL">HadCRUT4HadSST4 filled in with kriging</a> (1850-now, Cowtan and Way)</div>
...
<a href="getindices.cgi?WMO=NODCData/temp100_Pacific&STATION=Pacific_Ocean_mean_temperature&TYPE=i&id=$EMAIL">Pacific</a> (<a href="getindices.cgi?WMO=NODCData/temp100_North_Pacific&STATION=North_Pacific_mean_temperature&TYPE=i&id=$EMAIL">N</a>, <a href="getindices.cgi?WMO=NODCData/temp100_South_Pacific&STATION=South_Pacific_mean_temperature&TYPE=i&id=$EMAIL">S</a>) (1955-now, NODC)<br>
...
<a href="getindices.cgi?WMO=NODCData/temp700_Pacific&STATION=Pacific_Ocean_mean_temperature&TYPE=i&id=$EMAIL">Pacific</a> (<a href="getindices.cgi?WMO=NODCData/temp700_North_Pacific&STATION=North_Pacific_mean_temperature&TYPE=i&id=$EMAIL">N</a>, <a href="getindices.cgi?WMO=NODCData/temp700_South_Pacific&STATION=South_Pacific_mean_temperature&TYPE=i&id=$EMAIL">S</a>) (1955-now, NODC)<br>
...
<a href="getindices.cgi?WMO=NODCData/temp2000_Pacific&STATION=Pacific_Ocean_mean_temperature&TYPE=i&id=$EMAIL">Pacific</a> (<a href="getindices.cgi?WMO=NODCData/temp2000_North_Pacific&STATION=North_Pacific_mean_temperature&TYPE=i&id=$EMAIL">N</a>, <a href="getindices.cgi?WMO=NODCData/temp2000_South_Pacific&STATION=South_Pacific_mean_temperature&TYPE=i&id=$EMAIL">S</a>) (2005-now, NODC)</div>
...
<tr><td><!--Sea level--><td><div class="kalelink"><a href="getindices.cgi?WMO=SiegenData/ssh_dangendorf_mo&STATION=global_sea_level&TYPE=i&id=$EMAIL">Global sea level reconstruction</a> (1902-2015, Dangendorf et al 2019, <a href="getindices.cgi?WMO=SiegenData/dssh_dangendorf_mo&STATION=global_sea_level&TYPE=i&id=$EMAIL">uncertainty</a>), <a href="getindices.cgi?WMO=SiegenData/ssh_dangendorf_mo_extended&STATION=global_sea_level&TYPE=i&id=$EMAIL">extended with AVISO</a></div></a>
<td><a href="https://www.nature.com/articles/s41558-019-0531-8" target="_new"><img src="images/info-i.gif" alt="more information" border="0"></a>
...
<tr><td>Radiation<td><div class="kalelink">1750-2017 <a name="ERF">effective radiative forcings</a> <a href="getindices.cgi?WMO=LeedsData/CO2_ERF&id=$EMAIL">CO<sub>2</sub></a>, <a href="getindices.cgi?WMO=LeedsData/Other_Well_mixed_GHG_ERF&id=$EMAIL">other well-mixed greenhouse gases</a>, <a href="getindices.cgi?WMO=LeedsData/Tropospheric_O3_ERF&id=$EMAIL">tropospheric ozone</a>, <a href="getindices.cgi?WMO=LeedsData/Stratospheric_O3_ERF&id=$EMAIL">stratospheric ozone</a>, <a href="getindices.cgi?WMO=LeedsData/total_aerosol_ERF&id=$EMAIL">total aerosol</a>, <a href="getindices.cgi?WMO=LeedsData/land_use_change_ERF&id=$EMAIL">land use change</a>, <a href="getindices.cgi?WMO=LeedsData/stratospheric_water_vapour_ERF&id=$EMAIL">stratospheric water vapour</a>, <a href="getindices.cgi?WMO=LeedsData/black_carbon_snow_ERF&id=$EMAIL">black carbon on snow</a>, <a href="getindices.cgi?WMO=LeedsData/Contrails_ERF&id=$EMAIL">contrails</a>, <a href="getindices.cgi?WMO=LeedsData/Solar_ERF&id=$EMAIL">solar</a>, <a href="getindices.cgi?WMO=LeedsData/Volcanic_ERF&id=$EMAIL">volcanic</a>, <a href="getindices.cgi?WMO=LeedsData/Total_ERF&id=$EMAIL">total</a>, <a href="getindices.cgi?WMO=LeedsData/Anthropogenic_total_ERF&id=$EMAIL">total anthropogenic</a> (1750-2017, AR5 extended)</div>
<td><a href="https://doi.org/10.1029/2018JD028481" target="_new"><img src="images/info-i.gif" alt="more information" border="0"></a>

<tr><td>&nbsp;<td><div class="kalelink">1979-now annual <a href="getindices.cgi?WMO=NOAAData/CO2_noaa&id=$EMAIL">CO<sub>2</sub></a>, <a href="getindices.cgi?WMO=NOAAData/CH4_noaa&id=$EMAIL">CH<sub>4</sub></a>, <a href="getindices.cgi?WMO=NOAAData/N2O_noaa&id=$EMAIL">N<sub>2</sub>O</a>, <a href="getindices.cgi?WMO=NOAAData/CFC_noaa&id=$EMAIL">CFC-12</a>, <a href="getindices.cgi?WMO=NOAAData/HCFCs&id=$EMAIL">HCFCs</a> <a href="getindices.cgi?WMO=NOAAData/HFCs&id=$EMAIL">HFCs</a>, <a href="getindices.cgi?WMO=NOAAData/Total_noaa&id=$EMAIL">Total</a>, <a href="getindices.cgi?WMO=NOAAData/AGGI_noaa&id=$EMAIL">Annual Greenhouse Gas Index</a> (NOAA/ESRL)</div>
<td><a href="https://www.esrl.noaa.gov/gmd/aggi/aggi.html" target="_new"><img src="images/info-i.gif" alt="more information" border="0"></a>

<tr><td>&nbsp;<td><div class="kalelink"><a href="getindices.cgi?WMO=CDIACData/maunaloa_f&STATION=Mauna_Loa_CO2&TYPE=i&id=$EMAIL">Mauna Loa CO<sub>2</sub> concentrations</a> (1958-now, NOAA), <a href="getindices.cgi?WMO=CDIACData/maunaloa_log&STATION=log_Mauna_Loa_CO2&TYPE=i&id=$EMAIL">logarithm</a></div>
...
<tr><td>&nbsp;<td><div class="kalelink">Global <a href="getindices.cgi?WMO=CDIACData/global_co2_fossil&STATION=CO2_fossil&TYPE=i&NPERYEAR=1&id=$EMAIL">fossil fuel</a>, <a href="getindices.cgi?WMO=CDIACData/global_co2_landuse&STATION=CO2_landuse&TYPE=i&NPERYEAR=1&id=$EMAIL">land use</a>, <a href="getindices.cgi?WMO=CDIACData/global_co2_emissions&STATION=CO2_emissions&TYPE=i&NPERYEAR=1&id=$EMAIL">total</a>, cumulative <a href="getindices.cgi?WMO=CDIACData/cum_global_co2_fossil&STATION=cum_CO2_fossil&TYPE=i&NPERYEAR=1&id=$EMAIL">fossil fuel</a>, <a href="getindices.cgi?WMO=CDIACData/cum_global_co2_landuse&STATION=cum_CO2_landuse&TYPE=i&NPERYEAR=1&id=$EMAIL">land use</a>, <a href="getindices.cgi?WMO=CDIACData/cum_global_co2_emissions&STATION=cum_CO2_emissions&TYPE=i&NPERYEAR=1&id=$EMAIL">total</a></div>
<td><a href="https://www.globalcarbonproject.org/carbonbudget/19/data.htm" target="_new"><img src="images/info-i.gif" alt="more information" border="0"></a>
...
<tr><td>Land ice</td><td><div class="kalelink">GRACE <a href="getindices.cgi?WMO=GRACEData/greenland_mass&STATION=Greenland_mass&TYPE=i&id=$EMAIL">Greenland</a>, <a href="getindices.cgi?WMO=GRACEData/antarctica_mass&STATION=Antarctica_mass&TYPE=i&id=$EMAIL">Antarctica</a>, <a href="getindices.cgi?WMO=GRACEData/ocean_mass&STATION=ocean_mass&TYPE=i&id=$EMAIL">ocean</a> mass changes (2002-now, NASA/JPL)</td><td><a href="https://climate.nasa.gov/vital-signs/ice-sheets/" target="_new"><img src="images/info-i.gif" alt="more information" border="0"></a>
