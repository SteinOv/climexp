...
replot
EOF
        [ "$lwrite" = true ] && echo $DIR/bin/diamond2year "$corrroot.eps" "data/$TYPE$WMO${FORM_num}.dump$ext1" ${FORM_xlo:--3e33} ${FORM_xhi:-3e33} ${FORM_ylo:--3e33} ${FORM_yhi:-3e33}
